...
exports.render = function(php, config) {
    ...
    for(var tpl in left) {
        ...
        left[tpl].data = dir + sep + 'data.json';

        edp.log.info(edp.chalk.yellow('Render') + ' ' + tpl + ': ' + left[tpl]['tpl'] + ' ' + left[tpl]['data']);
    }
    ...
    for(var tpl in right) {
        ...
        right[tpl].data = dir + sep + 'data.json';

        edp.log.info(edp.chalk.yellow('Render') + ' ' + tpl + ': ' + right[tpl]['tpl'] + ' ' + right[tpl]['data']);
    }
