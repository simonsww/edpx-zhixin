...
class Smarty extends Smarty_Internal_Data {
    ...
    */
    ...
    {
        $this->template_dir = array_keys(array_flip(array_merge((array)$this->template_dir, (array)$template_dir)));
        return;
    }
    ...
    {
        $this->plugins_dir = array_keys(array_flip(array_merge((array)$this->plugins_dir, (array)$plugins_dir)));
        return;
    }
