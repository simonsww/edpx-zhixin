...
{%block name='data_modifier'%}
    {%$escaped_card_name='ecl-edu-abroad-info'%}
{%/block%}
...
<style>
.ecl-edu-abroad-info-title{font-size:1.17em;margin-top:0}.ecl-edu-abroad-info-container{line-height:1.7692307692;position:relative}.ecl-edu-abroad-info-container h4,.ecl-edu-abroad-info-container h5{margin:0;font-weight:normal}.ecl-edu-abroad-info-no-data{padding:2.5em 1em;text-align:center}.zx-tip-layer{display:block;position:absolute}.ecl-edu-abroad-info-image-tag{display:block;line-height:0;position:relative;_zoom:1}.ecl-edu-abroad-info-image-tag img{width:142px;height:142px}.ecl-edu-abroad-info-image-tag-wrapper{position:absolute;left:0;bottom:0;width:142px;height:21px;_bottom:-1px}
.ecl-edu-abroad-info-image-tag-mask{background-color:#000;width:100%;height:100%;opacity:.6;filter:alpha(opacity=60)}.ecl-edu-abroad-info-image-tag-text{color:#FFF;font-weight:normal;position:absolute;left:0;top:0;width:142px;height:21px;line-height:21px;text-align:center}.ecl-edu-abroad-info-image-tag{text-decoration:none!important}.ecl-edu-abroad-info-image-tag-mask,.ecl-edu-abroad-info-image-tag-text{cursor:pointer}.ecl-edu-abroad-info-info{line-height:1.538461538461538}
</style>

{%strip%}
<div class="{%$escaped_card_name%}-container c-row" data-click="{'fm': 'alop'}">

    <a class="{%$escaped_card_name%}-image-tag c-span6"
        href="{%$tplData.queryurl|escape:'html'%}"
        target="_blank">

        <img src="{%$tplData.edu.class_img%}" />
        ...
        <div class="{%$escaped_card_name%}-image-tag-wrapper">
            ...
            <div class="{%$escaped_card_name%}-image-tag-text">
                {%$tplData.edu.class_name%}
            </div>
        </div>
    </a>

    <div class="{%$escaped_card_name%}-info c-span18 c-span-last">
        <a href="{%$tplData.edu.info_title_url|escape:'html'%}" target="_blank">
            {%$tplData.edu.info_title_cut%}
        </a>

        <p class="{%$escaped_card_name%}-desc">
            {%$tplData.edu.info_desc_cut%}
        </p>

        {%foreach $tplData.edu.other_infos as $item%}
        <a href="{%$item.info_title_url|escape:'html'%}" class="{%$escaped_card_name%}-other-info" target="_blank">
            {%$item.info_title_cut%}
        </a>
        <br />
        {%/foreach%}
