...
<style>
{%fe_fn_c_css css="btn"%}
.ecl-edu-course-test-title{font-size:1.17em;margin-top:0}.ecl-edu-course-test-container{line-height:1.7692307692;position:relative}.ecl-edu-course-test-container h4,.ecl-edu-course-test-container h5{margin:0;font-weight:normal}.ecl-edu-course-test-no-data{padding:2.5em 1em;text-align:center}.zx-tip-layer{display:block;position:absolute}.ecl-edu-course-test-filter{height:1.307692307692308em;overflow:hidden;position:relative;*zoom:1}.ecl-edu-course-test-filter:before,.ecl-edu-course-test-filter:after{display:table;line-height:0;content:""}
...
.ecl-edu-course-test-ui-pager .ecl-edu-course-test-ui-pager-next em{background:url('http://s1.bdstatic.com/r/www/cache/biz/ecom/edu/img/icon_20131011.gif') no-repeat -6px -12px;width:6px;height:10px;right:.3846153846153846em}.c-tip-con .c-tip-cer{color:#666;margin:0 10px 1px 10px}.opui-honourCard{color:#666;line-height:1.5em}.opui-honourCard-score{width:60px;padding:4px 2px 4px 2px;text-align:center;float:left}.opui-honourCard-score em{display:block;font-size:37px;line-height:37px;color:#8e8d8d;font-family:arial;font-style:normal}.opui-honourCard-info{background:#f5f5f5;overflow:hidden}
.opui-honourCard-title a i{position:relative;left:-70px}.opui-honourCard ol{list-style:none;margin:4px 0 0;padding:0;float:left}.opui-honourCard li{height:20px;line-height:20px;padding-left:20px}.opui-honourCard li i{vertical-align:middle}.opui-honourCard-selected{color:#2b2a2a;font-weight:bold;background:url(http://www.baidu.com/cache/aladdin/ui/honourCard/img/honourCard.png) no-repeat 3px 5px}.ecl-edu-course-test-container{padding-bottom:.3846153846153846em}.ecl-edu-course-test-city-layer{top:1.8461538462em}
.ecl-edu-course-test-filter{padding-top:.3846153846em}.ecl-edu-course-test-tag-list{width:28em}.ecl-edu-course-test-tag-list a{padding-left:.5em;padding-right:.5em}.ecl-edu-course-test-city-selector{position:absolute;right:.7692307692307692em;top:.7692307692307692em;z-index:2}.ecl-edu-course-test-data-list{*zoom:1}.ecl-edu-course-test-data-list:before,.ecl-edu-course-test-data-list:after{display:table;line-height:0;content:""}.ecl-edu-course-test-data-list:after{clear:both}.ecl-edu-course-test-data-list li{float:left;width:100%;border-bottom:1px solid #f3f3f3;padding-bottom:.3846153846153846em;margin-top:-0.3076923076923077em}
.ecl-edu-course-test-data-list h5{font-size:1.1em}.ecl-edu-course-test-data-list h5 a{display:inline-block;*display:inline;*zoom:1}.ecl-edu-course-test-data-list label{color:#666}.ecl-edu-course-test-data-list .c-span-last{padding-top:1.846153846153846em;text-align:right;line-height:0}.ecl-edu-course-test-data-list .c-span-last .ecl-edu-course-test-wrapper{display:inline-block;*display:inline;*zoom:1;width:5.538461538461538em;text-align:center}.ecl-edu-course-test-data-list .c-span-last strong{color:#ffb400;font-size:1.1em;line-height:1em}
.ecl-edu-course-test-data-list .c-span-last .c-btn{display:block;margin-top:.5384615384615385em;font-size:13px}.ecl-edu-course-test-org-logo{border:1px solid #f0f0f0;display:block;padding:1px;line-height:0;margin-top:.3076923076923077em}.ecl-edu-course-test-org-logo img{width:59px;height:59px}.ecl-edu-course-test-course-address{display:inline-block;*display:inline;*zoom:1;margin-left:2em}.ecl-edu-course-test-consult,.ecl-edu-course-test-video,.ecl-edu-course-test-reserve{color:#666;font-size:.9em}.ecl-edu-course-test-consult .c-icon,.ecl-edu-course-test-video .c-icon,.ecl-edu-course-test-reserve .c-icon{cursor:pointer}
</style>
            ...
            <div class="c-span17">
                ...
                <div>
                    <h5 data-click="{'rsv_edu-click': 'coursetitle{%$item@index%}'}">
                        ...
                        {%if !$item.bridgeurl OR !$item.reserve_url%}
                            {%if $item.videourl%}
                            <a class="{%$escaped_card_name%}-video c-gap-icon-left-small"
                ...
                <div class="{%$escaped_card_name%}-last-row">
                    ...
                    <div class="{%$escaped_card_name%}-course-address">
                        <label>
                            {%if $item.address_1 == '在线课程'%}类型{%elseif $item.address_1%}校区{%/if%}
                            ：
                        </label>
...
t.find("a").each(function(){var e=$(this),n=e.data("tagid");null!=n&&i[n]&&e.addClass(CLASS_ACTIVE)})})},render:function(i){var a=filterHelper.getRenderData(i);a.length>0?(a=a[0],n.html(a.title+"："),t.html(a.content),e.css({visibility:"visible"})):e.css({visibility:"hidden"})},dispose:function(){t.off(),e=n=t=null}};return disposeList.push(i),i}();
            var dataList=function(){function e(){var e=Number(data.get("total")),n={"margin-bottom":"0"};2>e&&(n["border-bottom"]="none",n["padding-bottom"]="0");var i=t.find("li");i.length>0&&i.last().css(n)}var t=lib.query("data-list"),n="http://www.baidu.com/cache/biz/ecom/edu/org-default.jpg",i='<li class="c-row c-gap-bottom"><div class="c-span3"><a href="${logourl}" class="'+lib.getClass("org-logo")+' EC_ZHIXIN" target="_blank">'+'<img src="${logo}" />'+"</a>"+"</div>"+'<div class="c-span17">'+"<div>"+"<h5 data-click=\"{'rsv_edu-click': 'coursetitle${index}'}\">"+'<a href="${titleurl}" class="EC_ZHIXIN" target="_blank">'+"${title}"+"</a>"+"${coupon}${consult}${video}${reserve}"+"</h5>"+"</div>"+"<div>"+"<label>简介：</label>${intro}"+"</div>"+"<div>"+"<label>优势：</label>${teacher}"+"</div>"+'<div class="'+lib.getClass("last-row")+'">'+"<label>机构：</label>${org}${vcard}"+'<div class="'+lib.getClass("course-address")+'">'+"${address}"+"</div>"+"</div>"+"</div>"+'<div class="c-span4 c-span-last">'+'<div class="'+lib.getClass("wrapper")+'">'+"${price}${detail}"+"</div>"+"</div>"+"</li>",a={org:function(e,t){return'<a class="'+lib.getClass("org")+" EC_ZHIXIN\" data-click=\"{'rsv_edu-click': 'courseorg"+t+"'}\" "+'href="'+e.orgurl+'" target="_blank">'+e.orgname+"</a>"
},vcard:function(e){if(e.vcard&&"[]"!==e.vcard){var t=$.parseJSON(e.vcard);if(t.value2)return'<a class="c-icon c-icon-v c-icon-v'+t.value2+' c-gap-icon-left-small" '+'data-tooltips="bl" '+"data-renzheng='"+e.vcard+"'>"+"</a>"}return""},address:function(e){var t;return t=e.addressurl?'[<a class="EC_ZHIXIN" href="'+e.addressurl+'" target="_blank">地图</a>]':"","<label>"+("在线课程"===e.address_1?"类型":"校区")+"：</label>"+e.address_1+t},coupon:function(e){return e.reserve_url?'<a href="'+e.reserve_url+'" target="_blank" class="c-text c-text-warning c-gap-icon-left-small zx-edu-coupon" data-coupon="{\'text\': \''+e.reserve_desc+"', 'a': {'url': '"+e.reserve_url+"', 'text': '立即免费预约'}}\">惠</a>":""
},consult:function(e){return e.bridgeurl?'<a class="'+lib.getClass("consult")+' c-gap-icon-left-small" href="'+e.bridgeurl+'" target="_blank">'+'<i class="c-icon c-icon-qa"></i>咨询'+"</a>":""},video:function(e){return e.bridgeurl&&e.reserve_url||!e.videourl?"":'<a class="'+lib.getClass("video")+' c-gap-icon-left-small" href="'+e.videourl+'" target="_blank">'+'<i class="c-icon c-icon-ting"></i>试听'+"</a>"},reserve:function(e){return e.reserve_url?'<a class="'+lib.getClass("reserve")+' c-gap-icon-left-small" href="'+e.reserve_url+'" target="_blank">'+'<i class="c-icon c-icon-calendar-blue"></i>预约'+"</a>":""
},price:function(e){"暂无"===e.cost&&(e.cost="");var t=e.saleprice||e.cost||"&nbsp;";return"<strong>"+t+"</strong>"},detail:function(e,t){return"<a class=\"c-btn c-btn-mini c-btn-primary EC_ZHIXIN\" data-click=\"{'rsv_edu-click':'coursedetail"+t+"'}\" "+'hidefocus="true" href="'+e.detailurl+'" target="_blank">查看详情</a>'}},r={init:function(){e(),data.onchange("list",function(){var e=data.get("list");r.render(e),tip.init({renzheng:"c-icon-v","coupon.edu":"zx-edu-coupon"})})},render:function(r){if("string"==typeof r)t.addClass(lib.getClass("no-data")).html(r);
else{for(var s,o,c=[],l=0,u=r.length;u>l;l++)s=r[l],o={index:l,title:s.ori_title_cut_1,titleurl:s.titleurl,logo:s.orglogo||n,logourl:s.orglogo_url,intro:s.intro_cut,teacher:s.teacherdesc_cut,address:a.address(s,l),coupon:a.coupon(s,l),consult:a.consult(s,l),video:a.video(s,l),reserve:a.reserve(s,l),org:a.org(s,l),vcard:a.vcard(s,l),price:a.price(s,l),detail:a.detail(s,l)},c.push(lib.renderTpl(i,o));t.removeClass(lib.getClass("no-data")).html(c.join("")),e()}},dispose:function(){t=n=i=a=e=null}};return disposeList.push(r),r
}();
