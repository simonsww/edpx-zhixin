...
var n={};return n.hospitalid=t.hospitalid,n.vCardLevel=e.creditLevel||"",n.vcardData=lib.stringify({title:lib.encodeHTML(t.oriName||""),content:{spread:t.spread||"",url:lib.encodeHTML(e.url||""),certification:lib.encodeHTML(e.certification||""),alicense:e.alicense,creditLevel:e.creditLevel,creditValue:e.creditValue}}),i.replace(/\$\{([\w.]+)\}/g,function(e,t){return null!=n[t]?n[t]:""})}return!1}};
                ...
                function HealthView(e){function i(i){var t=[],n=e.temp;i.review&&(void 0===i.review.rate&&(i.review.rate=i.review.star),i.review.ratePercent=20*i.review.rate||20);var l=i.links;if(l){l.introLink&&t.push('<a href="'+l.introLink+'" target="_blank">医院介绍</a>'),l.labLink&&t.push('<a href="'+l.labLink+'" target="_blank">科室列表</a>'),l.expertLink&&t.push('<a href="'+l.expertLink+'" target="_blank">专家列表</a>');var o="";l.shangqiao?o+='<li class="icon-qiao"><i class="c-icon c-icon-qa icon-head"></i><a href="'+l.shangqiao+"\"  data-click=\"{'btn-name':'shangqiao', 'hid':'"+i.hospitalid+'\'}" target="_blank">咨询</a>'+"</li>":l.shangqiaolinks&&(o+='<li class="icon-qiao ecl-health-guahao-wrapper">'+r.getShangQiaoHTML(l.shangqiaolinks)+'<i class="c-icon c-icon-qa icon-head"></i>'+'<span class="link-guahao"'+" data-click=\"{'btn-name':'shangqiao', 'hid':'"+i.hospitalid+"'}\" >咨询</span>"+"</li>"),l.guahao?o+='<li class="icon-guahao"><i class="c-icon c-icon-register icon-head"></i><a href="'+l.guahao+"\"  data-click=\"{'btn-name':'guahao', 'hid':'"+i.hospitalid+'\'}" target="_blank">挂号</a>'+"</li>":l.guahaolinks&&(o+='<li class="icon-guahao ecl-health-guahao-wrapper">'+r.getGuaHaoHTML(l.guahaolinks)+'<i class="c-icon c-icon-register icon-head"></i>'+'<span class="link-guahao"'+" data-click=\"{'btn-name':'guahao', 'hid':'"+i.hospitalid+"'}\" >挂号</span>"+"</li>"),i.vCardMoreLink=o
}i.sublinks=t.join("| ");var c=i.review;if(c){var s="";c.num>0?(s=c.num,c.num>=1e4?s=Math.floor(c.num/1e4)+"万":c.num>=1e3&&(s=Math.floor(c.num/1e3)+"千"),s+="条评论"):s="我要评论",i.reviewText=s,i.reviewHtml=n.bind(i,a.review)}var d=vCard.vcardIcon.render(i.idcard,i);d!==!1&&(i.vCardText=d),i.position&&(i.locationHTML='<div class="pagelist-location"><i class="c-icon c-icon-location"></i><a href="'+i.position.url+'" target="_blank">'+i.position.addr+"</a></div>"),i.creative&&+i.spread&&(i.creative+='<a target="_blank" data-click="{\'btn-name\':\'tuiguang\'" class="pagelist-tuiguang" href="'+e.pageData.spreadLinkUrl+'">推广</a>'),i.tag&&(i.pagelistTags='<span class="pagelist-tags">'+i.tag.split(",").join("<br>")+"</span>"),e.pageData.debugon&&(i.debugon=' data-debug="'+(i.debug||"")+'"')
}function t(e,i){var t="";lib.each(e,function(e){t+=lib.format('<li style="background:url(#{logo}) 0 2px no-repeat"><a target="_blank" href="#{url}">#{title}</a></li>',e)});var a='<div class="ecl-health-guahaopop"><strong class="tip-title">您可以进入以下网站进行'+i+"：</strong>"+'<div class="tip-content">'+"<ul>"+t+"</ul>"+"</div>"+'<i class="tip-dir"></i>'+"</div>";return a}var a=e.temps,n=[],r=this;r.init=function(){r.fixUI()},r.update=function(t){if(t&&(n=t.hospitals,lib.extend(e.pageData,t)),t.queryTitle){var r=qq("ecl-health-queryUrl");
r.innerHTML=t.queryTitle}if(t.queryUrl){var r=qq("ecl-health-queryUrl");r.href=t.queryUrl}var l=e.temp,o=[];0===n.length&&o.push('<div class="ecl-health-empty-tip">未找到您所描述的精确信息</div>');for(var c=0,s=n.length;s>c;c++){var d=n[c];i(d),o.push(l.bind(n[c],a.pageitem))}qq("ecl-health-pagelist").innerHTML=o.join("")},r.fixUI=function(){if(e.pageData.pageNum<2){var i=q("ecl-health-pagelist-item");i&&(i=i.pop(),i.style.border="0px")}-1==e.pageData.provID&&e.filter?e.filter.hideField("region"):e.filter&&e.filter.showField("region")
},e.show=function(e){var e=qq(e);e&&(e.style.display="block")},e.setText=function(e,i){e=qq(e),e&&lib.browser.ie?e.innerHTML=i:e&&(e.textContent=i)},r.getGuaHaoHTML=function(e){return t(e,"挂号")},r.getShangQiaoHTML=function(e){return t(e,"咨询")}}
                function Health(){var e=lib.extend({},lib.observable);return e.env={indexDS:"ecomui/health"},e.init=function(){e.temp=new Template(e.temps),e.model=new HealthModel(e),e.view=new HealthView(e),e.filter=new HealthFilter(e);var i=e.filter,t=e.model,a=e.view;if(t.init(e.pageData),i.init(),t.params.tagList=i.tagList.join(";"),a.init(),vCard.bind({container:qq("ecl-health-pagelist"),parent:qq("ecl-health-left")}),guahaoCard.bindEvent(),i.onchange=function(e){var i={tags:e.value,pageID:1,field:e.field};e.provID&&(i.provID=e.provID),t.query(i)
