{%extends 'c_base.tpl'%} {%block name='content'%}<style type="text/css" data-merge>{%fe_fn_c_css css='img'%}.op_constellation01{font-size:1.08em}.op_constellation01_left{float:left;cursor:pointer}.op_constellation01_anchor{text-decoration:none}.op_constellation01_title{text-decoration:underline}.op_constellation01_subtitle{color:#666}</style>{%$imgs=['http://www.baidu.com/aladdin/img/stars/baiyang.png',
