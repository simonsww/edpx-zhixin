        ...
        <div class="ecl-weigou-header">
            <div class="ecl-weigou-header-inner">
                <div class="ecl-weigou-header-left">
                    {%assign var="weigou_title" value=($extData.OriginQuery|cat:"（共"|cat:$tplData.totalCount|cat:"款）正品特惠 更有0元商品天天抢_百度微购") %}
                    <a href="http://weigou.baidu.com/search?q={%$extData.OriginQuery|escape:'url'%}" title="{%$weigou_title|escape:'html'%}" target="_blank">{%$weigou_title|escape:'html'|limitlen:80|highlight:0%}</a>
                </div>
