...
{%$debugon=0%}
<style type="text/css">
.ecl-health-operation-mix{width:538px;font-size:13px}.ecl-health-operation-mix .knowledge-lines{margin-top:2px}.ecl-health-operation-mix .item-pic-link{float:left;text-decoration:none;color:#FFF;margin-top:4px;position:relative;height:91px}.ecl-health-operation-mix .item-pic-link i{display:block;width:121px;text-align:center;line-height:16px;position:absolute;bottom:0;font-style:normal;cursor:pointer;background:#000;filter:alpha(opacity=70)\8;background:rgba(0,0,0,0.7)}.ecl-health-operation-mix .item-pic-link img{border:0;width:121px;height:91px}
.ecl-health-operation-mix .knowledge-links{margin-left:138px;line-height:21px}.ecl-health-operation-mix .knowledge-links .item-info{line-height:20px}.ecl-health-operation-mix .knowledge-links .item-category{float:right;color:#666}.ecl-health-operation-mix .knowledge-showurl{line-height:19px}.ecl-health-operation-mix .knowledge-showurl .c-icon{margin-left:5px}.ecl-health-operation-mix .tag-links{clear:both;padding-left:11px;line-height:21px;background:url('http://s1.bdstatic.com/r/www/cache/biz/ecom/health/point.gif') 0 7px no-repeat}
.ecl-health-operation-mix .tag-links em{color:#00C;margin:0 5px}
</style>
{%strip%}{%*医疗手术卡片图文版*%}
<div id="ecl-health-operation-mix" class="ecl-health-operation-mix">
  <h3 class="t">
    ...
    <div class="knowledge-line">
      ...
      <div class="knowledge-links">
        {%foreach $tplData.links as $item%}
          <div{%if $debugon%} data-debug="{%$item.debug|escape:'html'%}"{%/if%}>
            <p>
