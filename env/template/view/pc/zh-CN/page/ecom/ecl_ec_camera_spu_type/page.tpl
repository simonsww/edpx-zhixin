...
<script>
    A.init(function(){
        ...
        baidu.dom.ready(function() {
            loadScript('http://www.baidu.com/cache/biz/ecom/weigou/card/camera_spu_type-1.2.js');
        });
    });
</script>
