...
.ecl-pc-gmgg .games-type-list .games-type-selected,.ecl-pc-gmgg .games-subject-list .games-type-selected{background:#5a9ff1;border:#418ce5 1px solid;border-radius:2px;color:#FFF}.ecl-pc-gmgg .games-type-list .games-subject-disabled:hover,.ecl-pc-gmgg .games-subject-list .games-subject-disabled:hover,.ecl-pc-gmgg .games-type-list .games-subject-disabled,.ecl-pc-gmgg .games-subject-list .games-subject-disabled{color:#CCC;text-decoration:none;cursor:text}.ecl-pc-gmgg .games-subject-more,.ecl-pc-gmgg .games-type-more{float:left;width:50px;line-height:30px;height:30px}
.ecl-pc-gmgg .games-subject-more .icon-down,.ecl-pc-gmgg .games-type-more .icon-down,.ecl-pc-gmgg .games-subject-more .icon-up,.ecl-pc-gmgg .games-type-more .icon-up{display:block;width:7px;height:4px;position:absolute;margin-top:13px;*margin-top:6px;_margin-top:7px;margin-left:34px;background:url('http://s1.bdstatic.com/r/www/cache/biz/ecom/game/game-1.8.gif') -6px -32px no-repeat}.ecl-pc-gmgg .games-subject-more .icon-wrap,.ecl-pc-gmgg .games-type-more .icon-wrap{color:#333;padding:1px 16px 2px 5px;*padding-top:2px;_padding-top:3px;border:1px solid #fdfdfd}
.ecl-pc-gmgg .games-subject-more .icon-hover,.ecl-pc-gmgg .games-type-more .icon-hover,.ecl-pc-gmgg .games-subject-more .icon-wrap:hover,.ecl-pc-gmgg .games-type-more .icon-wrap:hover{background:#f2f8ff;border-color:#67a5eb}.ecl-pc-gmgg .games-subject-more .icon-down:hover,.ecl-pc-gmgg .games-type-more .icon-down:hover{cursor:pointer}.ecl-pc-gmgg .games-subject-more .icon-up,.ecl-pc-gmgg .games-type-more .icon-up{background-position:-20px -32px}.ecl-pc-gmgg .games-querytag{background:#fdfdfd;padding:0 0 7px 20px;*padding-top:1px}
.ecl-pc-gmgg .games-list{border-top:#ebebeb 1px solid;padding-top:10px;padding-left:22px;min-height:160px;_height:160px}.ecl-pc-gmgg .games-list-loading{text-align:center;padding-top:76px;padding-bottom:76px}.ecl-pc-gmgg .games-list-loading .loading-text{height:28px;line-height:28px;color:#333}.ecl-pc-gmgg .games-list-err{padding-top:76px;padding-bottom:76px}.ecl-pc-gmgg .games-list-err .loading-text{color:#333;padding-left:32px;height:28px;line-height:28px;background:url('http://s1.bdstatic.com/r/www/cache/biz/ecom/game/game-1.8.gif') no-repeat;width:280px;margin:0 auto}
...
var TabManager=function(){function e(e,t){var a="",s=e.length-1;return each(e,function(e,n){a+='<a href="#" hidefocus="on" data-code="'+(e.code||"")+'"'+' data-value="'+e.id+'"'+(e.id==t?'class="games-type-selected"':"")+">"+e.text+"</a>"+(s!=n?"|":"")}),a}function t(t,a){var s="0"===t.selectedsubject||0===t.selectedsubject,n="shouyou"==a?",rsv_vsgmtype:40":"",i='<div class="games-type'+(s?"":" games-type-expand")+' games-type-panel">'+'<b class="games-type-subject">按类型：</b>'+'<span class="games-type-list" data-click="{fm:\'beha\''+n+'}">',r=t.typelist_exp.length>1,o=t.typelist_exp.length-1;
...
}function t(){n.unbindDOM(),n.reload()}var n=this,i=e(),a=new SwitchTab(q("games-type-list",i));a.init(),a.on("change",function(){n.subjectTab&&n.subjectTab.reset(),t()}),a.show=function(){T.show(e())},a.hide=function(){T.hide(e())},n.typeTab=a;var s=q("games-subject-list",i);if(s){var r=new SwitchTab(s);r.init(),r.on("change",function(){n.typeTab.reset(),t()}),n.subjectTab=r;var o=new MoreToggle(i);o.init({subject:1})}var c=q("games-type-list",i);if(c){var l=new MoreToggle(i);l.init({type:1})}},_getParams:function(){var e=this.typeTab?{type:this.typeTab.getValue().value}:{type:0,needquerytag:1},t=this.orderTab;
t&&(e.ordertype=t.getValue().value);var n=this.subjectTab;return n&&(e.subject=n.getValue().value),e},_bindLink:function(){var e=this.opt.getParams(),t=T.url.jsonToQuery({query:e.query,qid:e.qid,sid:e.sid,resource_id:e.resource_id,version:e.version},encodeURIComponent);each(T.q("item-shouyou-link",this.opt.list),function(e){var n=e.href;e.href=n+(n.indexOf("?")>=0?"&":"?")+t})},_initOrderTab:function(){var e=this,t=this.opt.querytag;T.dom.insertHTML(t,"afterbegin",n);var i=q("games-ordertype-shouyou",t),a=new SwitchTab(i);
a.on("change",function(){e.unbindDOM(),e.reload()}),a.show=function(){T.show(i)},a.hide=function(){T.hide(i)},(e.orderTab=a).init()},init:function(){var e=this;e._initItemHover(),e.render=new ShouYouRender(e.opt),e.render.onRender=function(){e._bindLink()}},show:function(){var e=this;addClass(e.opt.list,t),e.typeTab&&e.typeTab.show(),e.orderTab?e.orderTab.show():e._initOrderTab()},hide:function(){removeClass(this.opt.list,t),this.typeTab&&this.typeTab.hide(),this.orderTab&&this.orderTab.hide()},showFirst:function(){var e=this;
