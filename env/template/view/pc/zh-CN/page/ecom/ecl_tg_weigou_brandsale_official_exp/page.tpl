...
.ecl-tg-brandsale-official .brand-list ul{display:block;overflow:hidden;margin-bottom:5px}.ecl-tg-brandsale-official .brand-list ul .item{display:inline-block;float:left;width:78px;margin-right:10px;overflow:hidden}.ecl-tg-brandsale-official .brand-list ul .item a{text-decoration:none;position:relative;overflow:hidden}.ecl-tg-brandsale-official .brand-list ul .item .pic{display:block;height:78px;width:78px;overflow:hidden}.ecl-tg-brandsale-official .brand-list ul .item .pic span{width:78px;padding:0;position:absolute;left:0;bottom:0}
...
<div class="ecl-tg-brandsale-official">
    ...
    <div class="brand-list">
        <ul>
            ...
            <li class="item{%if ($item@index + 1)%6 == 0%} item-right{%/if%}" title="{%$item.title|escape:'html'%}" data-click="{'fm': 'alop', 'rsv_click_index': '{%$item@index%}'}">
                <a href="{%$item.url%}" target="_blank" class="pic" data-click="{rsv_click_type:'item'}">
                    <img src="{%$item.imgurl%}" width="78" height="78" />
                    <span class="bg"></span>
