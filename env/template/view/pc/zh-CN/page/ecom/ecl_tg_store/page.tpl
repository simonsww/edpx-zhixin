...
.ecl-tg-detail-list .ecl-tg-item-expand .ecl-tg-item-content .ecl-tg-item-title{width:210px;overflow:hidden;height:16px}.ecl-tg-detail-list .ecl-tg-item-expand .ecl-tg-item-content .ecl-tg-item-title a{font-size:14px;color:#000;font-weight:bold;text-decoration:none}.ecl-tg-detail-list .ecl-tg-item-expand .ecl-tg-item-content .ecl-tg-item-title a:hover{text-decoration:underline}.ecl-tg-detail-list .ecl-tg-item-expand .ecl-tg-item-content .ecl-tg-item-desc{line-height:18px;height:36px;padding:6px 0 0;width:210px;overflow:hidden}
...
.ecl-tg-merchant .ecl-tg-detail-list .ecl-tg-item-expand .ecl-tg-item-title{display:none}.ecl-tg-merchant .ecl-tg-detail-list .ecl-tg-item-expand .ecl-tg-item-desc{height:54px}
</style>
...
{%function tg_zx_fn_detail_list items=[] max_item_count=8 all_active_count=3 has_num=true show_provider=true need_truncate=false%}
                ...
                <div class="ecl-tg-item-expand ecl-tg-clear">
                    <div class="ecl-tg-item-img">
                        <a href="{%$item.url%}" target="_blank"
                            ...
                            <img src="{%$item.img%}" alt="{%$item.title|escape:'html'%}">
                            <span class="ecl-tg-item-num {%$num_hot_cls%}">{%$iter|escape:html%}</span>
                            <span class="ecl-tg-item-provider {%if !$show_provider%}ecl-tg-item-provider-hide{%/if%}">{%$item.provider|escape:'html'%}</span>
                        </a>
                    </div>
                    <div class="ecl-tg-item-content">
                        ...
                        <div class="ecl-tg-item-desc">
                            <a href="{%$item.url%}" target="_blank"
                                ...
                                data-click="{rsv_click_value:'{%$index|escape:html%}'}">
                                {%if $need_truncate%}
                                    {%tg_zx_fn_truncate string=$item.desc length=38%}
                                {%else%}
...
{%function tg_zx_fn_bottom data=[] is_nuomi=false%}
    ...
    <div class="ecl-tg-link-promotion">
        ...
        <a href="{%$data.other_url%}" target="_blank">查看更多</a>
    </div>
    {%/if%}
    {%if $data.promotion_label%}
    <div class="ecl-tg-link-promotion">
        {%$data.promotion_label|escape:'html'%}：
        <a href="{%$data.promotion_url%}" target="_blank">{%$data.promotion_text|escape:'html'%}</a>
    </div>
    {%/if%}
...
{%* 知心10个商户需求卡片-针对糯米商品 *%}
<div class="ecl-tg ecl-tg-merchant">
    {%$info = $tplData.info%}
    ...
    <div class="ecl-tg-content" id="TgZxContent">
        ...
        <div class="ecl-tg-list ecl-tg-detail-list" id="TgZxDetailList"
            ...
            {%tg_zx_fn_detail_list items=$tplData.data.list max_item_count=3 has_num=false show_provider=false%}
        
        </div>
        <div class="ecl-tg-link-more {%if $tplData.data.total <= 3%}ecl-tg-hidden{%/if%}" id="TgZxLinkMore">
    ...
    <div class="ecl-tg-bottom" id="TgZxBottom">
        {%tg_zx_fn_bottom data=$info is_nuomi=true%}
    </div>
</div>
...
<script type="text/javascript">
    A.init(function(){var t=jQuery;t.extend({format:function(t,e){var a=t,i=Array.prototype.slice.call(arguments,1),l=Object.prototype.toString;return i.length?(i=1==i.length?null!==e&&/\[object Array\]|\[object Object\]/.test(l.call(e))?e:i:i,a.replace(/#\{(.+?)\}/g,function(t,e){var a=i[e];return"[object Function]"==l.call(a)&&(a=a(e)),"undefined"==typeof a?"":a})):a}});var e,a=this.data._tuanCityData,i=this.data._tuanAjaxUrl,l=this.data._type,r=this.data._query,c=a.current.id,n=a.current.text,s=(t("#TgZxList"),t("#TgZxCityBtn")),o=t("#TgZxCityOverlay"),d=!0;
this.dispose=function(){t(document).unbind("click",g.documentClickHandler),d||(d=!0,e=null)};var u=function(){s.bind("click",function(t){t.stopPropagation(),o.toggle()}),t(document).bind("click",g.documentClickHandler);var e=t("#TgZxCityTabs").children(),a=t("#TgZxCityItems").children();e.each(function(i,l){t(l).bind("click",function(){e.removeClass("ecl-tg-city-tab-active"),t(l).addClass("ecl-tg-city-tab-active"),a.hide(),a.eq(i).show()})}),t("#TgZxContent").bind("click",function(e){var a=e.target,i=t(a);if(t(a).hasClass("ecl-tg-filter-link")){e.preventDefault();
var l=a.parentNode.parentNode.parentNode,r=t(l).find(".ecl-tg-filter-link");r.each(function(e,a){t(a).removeClass("ecl-tg-filter-link-active")}),r.removeClass("ecl-tg-filter-link-active"),i.addClass("ecl-tg-filter-link-active"),g.sendRequest(l.parentNode.getAttribute("data-type"))}else if(i.hasClass("ecl-tg-city-item")){var s=t(a.parentNode.parentNode).find(".ecl-tg-city-item");t(s).each(function(e,a){t(a).removeClass("ecl-tg-city-item-active")}),i.addClass("ecl-tg-city-item-active"),c=i.attr("data-id"),n=i.html(),g.sendRequest("city"),o.hide(),t("#TgZxCityLabel").html(i.html())
}else if(i.hasClass("ecl-tg-filter-more")||t(a=a.parentNode).hasClass("ecl-tg-filter-more")){var d=t(a.parentNode),u="ecl-tg-filter-area-expand";d.hasClass(u)?d.removeClass(u):d.addClass(u)}})},p=['<div class="ecl-tg-item #{item_active_cls} #{item_first_cls} #{item_last_cls} #{item_no_num_cls}">','<div class="ecl-tg-item-expand ecl-tg-clear">','<div class="ecl-tg-item-img">','<a href="#{url}&pos=img" target="_blank" title="#{desc}">','<img src="#{img}" width="121" height="80">','<span class="ecl-tg-item-num #{num_hot_cls}">#{iter}</span>','<span class="ecl-tg-item-provider">#{provider}</span>',"</a>","</div>",'<div class="ecl-tg-item-content">','<div class="ecl-tg-item-title">','<a href="#{url}&pos=brand" target="_blank"title="#{title}">',"#{title}","</a>","</div>",'<div class="ecl-tg-item-desc">','<a href="#{url}&pos=title" target="_blank"','title="#{desc}">',"#{desc}","</a>","</div>",'<div class="ecl-tg-item-price">','<span class="ecl-tg-item-price-wrap">￥#{price}</span>','<span class="ecl-tg-item-price-wrap ecl-tg-ml10">#{discount}折</span>','<span class="ecl-tg-item-oriprice-wrap ecl-tg-ml10">原价：￥#{ori_price}</span>',"</div>","</div>",'<div class="ecl-tg-item-gosee">','<a href="#{url}&pos=gosee" target="_blank" class="ecl-tg-item-gosee-link">去看看</a>','<div class="ecl-tg-item-purchased-wrap">#{purchased}人已购</div>',"</div>","</div>",'<div class="ecl-tg-item-collapse ecl-tg-clear" title="#{desc}">','<div class="ecl-tg-item-num  #{num_hot_cls}">#{iter}</div>','<div class="ecl-tg-item-title">','<a href="javascript:void(0)">',"#{title_desc}","</a>","</div>",'<div class="ecl-tg-item-price">','<span class="ecl-tg-item-price-wrap">￥#{price}</span>','<span class="ecl-tg-item-oriprice-wrap">￥#{ori_price}</span>',"</div>","</div>","</div>"].join(""),g={genCityItems:function(e){var a=[],i=e.hot,l=e.all,r='<li class="OP_LOG_BTN ecl-tg-city-item" data-id="#{id}" data-click="{rsv_click_value:\'#{id}\'}">#{text}</li>';
a.push("<ul>");for(var c=0,n=i.length;n>c;c++)a.push(t.format(r,i[c]));for(a.push("</ul>"),c=0,n=l.length;n>c;c++){var s=(l[c].text,l[c].subcity);a.push('<ul style="display:none;">');for(var o=0,d=s.length;d>o;o++)a.push(t.format(r,s[o]));a.push("</ul>")}t("#TgZxCityItems")[0].innerHTML=a.join("")},getParams:function(e){var a={};if("city"!=e){var i=t("#TgZxFilters").find(".ecl-tg-filter-area");i.each(function(e,i){var l=t(i).attr("data-type")+"_id",r=t(i).find(".ecl-tg-filter-link-active")[0];if(r){var c=r.getAttribute("data-id");
a[l]=c}})}return a.pos=e,a.city_id=c,a.type=l,a.query=r,a.time_stamp=(new Date).valueOf(),a},getAjaxUrl:function(t){var e=g.getParams(t),a=g.jsonToQuery(e),l=i.indexOf("?")>-1?"&":"?",r=i+l+a;return r},sendRequest:function(a){d=!1,e=g.getSuccessHandler(a),t.ajax(g.getAjaxUrl(a),{dataType:"jsonp",jsonp:"cb",success:e,charset:"utf-8",timeOut:6e3})},reload:function(e,a){if(t("#TgZxContent").removeClass("ecl-tg-content-city-no-data"),t("#TgZxContent").removeClass("ecl-tg-content-filter-no-data"),0==e.data.total){"city"!=a?(g.renderFilters(e.filter),t("#TgZxContent").addClass("ecl-tg-content-filter-no-data")):t("#TgZxContent").addClass("ecl-tg-content-city-no-data")
}else g.renderList(e.data.list,{has_num:!1}),g.renderFilters(e.filter);g.renderLinks(t.extend(e.info,{total:e.data.total}))},renderList:function(e,a){if(!(e instanceof Array&&e.length>0))return t("#TgZxDetailList").html(""),void 0;a=a||{},a=t.extend({max_item_count:3,all_active_count:3,has_num:!0},a||{});var i=a.max_item_count,l=a.has_num,r=a.all_active_count,c=e.length;c>i&&(e=e.slice(0,i),c=i);var n=!1;r>=c&&(n=!0);for(var s=l?"":"ecl-tg-item-no-num",o=[],d=["ecl-tg-item-num-first","ecl-tg-item-num-second","ecl-tg-item-num-third"],u=0,g=c;g>u;u++){var v=e[u],m=u+1,h=d[u]||"",f="",_="",y="";
0==u&&(_="ecl-tg-item-first"),u==g-1&&(y="ecl-tg-item-last"),(0==u||n)&&(f="ecl-tg-item-active");var x="【"+v.title+"】"+v.desc;o.push(t.format(p,t.extend(v,{discount:Number(v.discount).toFixed(1),iter:m,num_hot_cls:h,item_active_cls:f,item_first_cls:_,title_desc:x,item_no_num_cls:s,item_last_cls:y})))}t("#TgZxDetailList")[0].innerHTML=o.join("")},renderFilters:function(e){var a=[];e=e||{};var i=!0,l=0,r={category:{label:"分类",type:"catg",need_truncate:!0},district:{label:"区域",type:"dist",need_truncate:!0},price:{label:"价格",type:"price",need_truncate:!1}};
for(var c in e){var n=r[c];if(n){var s=e[c];if(s&&!(s instanceof Array&&0==s.length)){i=!1,l++;var o={label:n.label,type:n.type,first:1==l,count_per_line:1==l?4:5,need_truncate:n.need_truncate};a.push(g.getFilterHtml(s,o))}}}i&&a.push('<div class="ecl-tg-filter-empty">为您找到以下团购：</div>'),t("#TgZxFilters")[0].innerHTML=a.join("")},getFilterHtml:function(e,a){var i=[];if(!(e instanceof Array&&e.length>0))return"";a=t.extend({count_per_line:5,max_line_count:3,label:"",type:"",first:!1,need_truncate:!1},a||{});var l=a.count_per_line,r=a.max_line_count,c=a.label,n=a.type,s=a.first,o=a.need_truncate,d=e.length,u=l*r,p="",g="";
d>u&&(e=e.slice(0,u),d=u),s&&(g="ecl-tg-filter-area-first"),i.push('<div class="ecl-tg-filter-area #{first_cls} ecl-tg-clear #{expand_cls}" data-click="{fm:\'beha\'}" data-type="#{type}">'),i.push(' <div class="ecl-tg-filter-label">#{label}：</div>'),i.push(' <div class="ecl-tg-filter-container" data-click="{rsv_click_type:\'#{type}\'}">');for(var v=0;d>v;v++){var m=[],h=e[v],f=v%l==0,_=v%l==l-1,y=v==d-1;f&&m.push('<div class="ecl-tg-filter-line ecl-tg-clear">'),m.push('<div class="ecl-tg-filter-wrap'),(_||y)&&m.push(" ecl-tg-filter-wrap-line-last"),m.push('">');
var x=h.text;h.truncated_text=x;var k=!1;o&&x.length>5&&(x=x.substr(0,4)+"...",h.truncated_text=x,k=!0),h.disable?m.push("<span>#{truncated_text}</span>"):(m.push('<a href="javascript:void(0)" data-id="#{id}" data-click="{rsv_click_value:\'#{id}\'}" class="ecl-tg-filter-link'),h.checked&&(m.push(" ecl-tg-filter-link-active"),v>=l&&(p="ecl-tg-filter-area-expand")),k?m.push('" title="#{text}"'):m.push('"'),m.push(">#{truncated_text}"),m.push("</a>")),m.push("</div>"),(_||y)&&m.push("</div>"),i.push(t.format(m.join(""),h))
}return i.push(" </div>"),d>l&&(i.push('<div class="ecl-tg-filter-more" data-click="{rsv_click_type:\'#{type}_more\'}">'),i.push(' <span class="ecl-tg-filter-expand-wrap">更多</span>'),i.push(' <span class="ecl-tg-filter-collapse-wrap">收起</span>'),i.push("</div>")),i.push("</div>"),t.format(i.join(""),{label:c,type:n,expand_cls:p,first_cls:g})},renderLinks:function(e){var a=[];a.push(" 没有相应团单，欢迎查看#{current_city}的"),a.push(' <a href="#{city_no_data_url}&pos=citynodata" target="_blank">其他团购</a>'),t("#TgZxCityNoData")[0].innerHTML=t.format(a.join(""),{current_city:n,city_no_data_url:e.city_no_data_url}),a=[],a.push('<a href="#{title_url}&pos=head" class="ecl-tg-title-link" target="_blank" data-click="{rsv_click_type:\'title\'}">'),a.push("#{title}"),a.push("</a>"),t("#TgZxTitle")[0].innerHTML=t.format(a.join(""),e),a=[],a.push('<a href="#{more_url}&pos=all" target="_blank" data-click="{rsv_click_type:\'see_more\'}">'),a.push("#{more_text}"),a.push("</a>"),e.total<=3?t("#TgZxLinkMore").addClass("ecl-tg-hidden"):t("#TgZxLinkMore").removeClass("ecl-tg-hidden"),t("#TgZxLinkMore")[0].innerHTML=t.format(a.join(""),e),a=[],e.other_label&&(a.push('<div class="ecl-tg-link-promotion">'),a.push("#{other_label}？"),a.push('<a href="#{other_url}&pos=more" target="_blank">查看更多</a>'),a.push("</div>")),e.promotion_label&&(a.push('<div class="ecl-tg-link-promotion">'),a.push("#{promotion_label}："),a.push('<a href="#{promotion_url}&pos=activity" target="_blank">#{promotion_text}</a>'),a.push("</div>")),a.push('<div class="ecl-tg-footer">'),a.push("tuan.baidu.com"),a.push("</div>"),t("#TgZxBottom")[0].innerHTML=t.format(a.join(""),e)
},documentClickHandler:function(e){var a=e.target;t.contains(o[0],a)||o.hide()},jsonToQuery:function(t){var e=[];for(var a in t)t.hasOwnProperty(a)&&e.push(a+"="+encodeURIComponent(t[a]));return e.join("&")},getSuccessHandler:function(t){return function(e){d=!0;var a=e;g.reload(a,t)}}};g.genCityItems(a),u()});
</script>
