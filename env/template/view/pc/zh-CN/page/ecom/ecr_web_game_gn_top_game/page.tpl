...
.ecr-top-panel-body-row-index-1{background-position:0 -90px}.ecr-top-panel-body-row-operate{position:absolute;top:0;right:0;height:28px}.ecr-top-panel-footer{white-space:nowrap;word-break:keep-all;text-overflow:ellipsis;padding-top:8px;overflow:hidden}.ecr-top-panel-footer-split{color:#bfbfbf}.ecr-web-game-gn-top-game{font-size:12px}.container_s .ecr-web-game-gn-top-game{width:270px;overflow:hidden}.container_l .ecr-web-game-gn-top-game{width:440px}.ecr-web-game-gn-top-game .title{position:relative;font-size:14px;height:22px;line-height:22px}
.ecr-web-game-gn-top-game .title h2{position:absolute;background:#fff;font-weight:bold;z-index:2;font-size:14px;margin:0;padding:0;padding-right:10px}.ecr-web-game-gn-top-game .title .line{position:absolute;top:11px;width:100%;height:0;font-size:0;border-top:1px solid #eaeaea;z-index:1}
</style>

<div class="ecr-web-game-gn-top-game ecr-top-panel ecr">
