...
.ecr-cards-panel-body-card-image img{width:68px;height:68px}.ecr-cards-panel-body-card-name{width:78px;text-align:center;font-size:13px;overflow:hidden;white-space:nowrap;word-break:keep-all;text-overflow:ellipsis}.ecr-pc-game-gn-also-search{font-size:12px}.container_s .ecr-pc-game-gn-also-search{width:270px;overflow:hidden}.container_l .ecr-pc-game-gn-also-search{width:440px}.ecr-pc-game-gn-also-search .title{position:relative;font-size:14px;height:22px;line-height:22px}.ecr-pc-game-gn-also-search .title h2{position:absolute;background:#fff;font-weight:bold;z-index:2;font-size:14px;margin:0;padding:0;padding-right:10px}
.ecr-pc-game-gn-also-search .title .line{position:absolute;top:11px;width:100%;height:0;font-size:0;border-top:1px solid #eaeaea;z-index:1}.ecr-pc-game-gn-also-search .all{position:absolute;top:0;right:0;height:22px;line-height:22px;background-color:#fff;z-index:2;font-size:12px;padding-left:2px}
</style>

<div class="ecr-pc-game-gn-also-search ecr-cards-panel ecr">
    <div class="title">
        <h2>{%$tplData.title%}</h2>
        <div class="line"></div>
         <a class="all" href="{%build_search_url params="wd={%$tplData.all.url%}&f=2&rsv_dl=0_right_game_{%$extData.resourceid%}"%}" target="_blank">{%$tplData.all.title%}&gt;&gt;</a>
    </div>
